...
class SparesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spare" do
    assert_difference('Spare.count') do
      post spares_url, params: { spare: { balance: @spare.balance, date_delivered: @spare.date_delivered, date_warranty: @spare.date_warranty, description: @spare.description, stock: @spare.stock } }
    end
  ...
  test "should update spare" do
    patch spare_url(@spare), params: { spare: { balance: @spare.balance, date_delivered: @spare.date_delivered, date_warranty: @spare.date_warranty, description: @spare.description, stock: @spare.stock } }
